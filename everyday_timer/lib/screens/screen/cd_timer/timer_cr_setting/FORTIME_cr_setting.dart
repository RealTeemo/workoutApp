...
class ForTimeSetting extends ConsumerStatefulWidget {
  const ForTimeSetting({super.key,});
...
class _ForTimeSettingState extends ConsumerState<ForTimeSetting> {
  ...
  void submitNewTimerData(){
    ...
    CdTimer temp= CdTimer(time: 0, title: titleController.text, sets: selectedSets);
    StoredTimer temp2;
    
    temp2 = StoredTimer(time: enteredTotalTime, title: "Work");
    temp.addTimer(temp2);
