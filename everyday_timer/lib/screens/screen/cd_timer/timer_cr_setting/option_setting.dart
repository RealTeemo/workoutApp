...
import 'package:everyday_timer/widgets/test.dart';
      ...
      child: Scaffold(
        ...
        body: TabBarView(children: [
          ...
          child: Column(
            ...
            children: <Widget>[
              buildButton(context, "AMRAP", const AmrapSetting(), Colors.orange),
              buildButton(context, "FOR TIME", const ForTimeSetting(), Colors.blue.shade300),
              buildButton(context, "TABATA", const TabataSetting(), Colors.purple.shade400),
              buildButton(context, "EMOM", const EmomSetting(), Colors.lime.shade400),
              buildButton(context, "ADVANCED", const AdvancedSetting(), Colors.black38),
            ],
          ),
        ),
        ], )
